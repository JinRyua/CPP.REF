...
const Vector3 Vector3::AxisX = Vector3(1, 0, 0);
const Vector3 Vector3::AxisY = Vector3(0, 1, 0);
const Vector3 Vector3::AxisZ = Vector3(0, 0, 1);
...
SString* Vector3::ToString() const
{
	return SString::Format("{{{0}, {1}, {2}}}"_s, X, Y, Z);
}
...
Vector3 Vector3::GetClampedToMaxLength(float inMaxLength) const
{
...
Vector3 Vector3::GetDirection() const
{
	return GetNormalized();
}

void Vector3::SetDirection(const Vector3& value)
{
