...
#define Left Planes[0]
#define Top Planes[1]
#define Right Planes[2]
#define Bottom Planes[3]
#define Near Planes[4]
#define Far Planes[5]
...
Frustum Frustum::Construct(const Matrix4x4& inViewProj)
{
	...
	f.Planes[0] = f.Planes[0].GetNormalized();
	...
	f.Planes[1] = f.Planes[1].GetNormalized();
	...
	f.Planes[2] = f.Planes[2].GetNormalized();
	...
	f.Planes[3] = f.Planes[3].GetNormalized();
	...
	f.Planes[4] = f.Planes[4].GetNormalized();
	...
	f.Planes[5] = f.Planes[5].GetNormalized();
